...
%
A matrix $A$ is \define{skew-symmetric} if $\transpose{A}=-A$  Exercises T30--T37 employ this definition.\\\\
\exercise{T30}{\robertbeezer}   % skew => square
\exercise{T31}{\manleyperkel}   % skew => zero diagonal
\exercise{T32}{\manleyperkel}   % skew, symmetric <=> zero matrix
