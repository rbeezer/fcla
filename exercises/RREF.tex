...
%
%
For problems C30--C33, row-reduce the matrix without the aid of a calculator, indicating the row operations you are using at each step using the notation of \acronymref{definition}{RO}.\\
%
