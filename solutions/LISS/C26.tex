...
\end{align*}
%
This system will have a solution for {\em every} vector on the right side if the row-reduced coefficient matrix has a leading one in every row, since then it is never possible to have a leading 1 appear in teh final colum of a row-reduced augmented matrix.  
%
\begin{align*}
\begin{bmatrix} 
1 & 2 & 0 & 1 & 1 \\ 
