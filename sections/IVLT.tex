...
\end{align*}
%
$T$ is invertible, which you are able to verify, perhaps by determining that the kernel of $T$ is empty and the range of $T$ is all of $P_2$.  This will be easier once we have \acronymref{theorem}{RPNDD}, which appears later in this section.\par
%
