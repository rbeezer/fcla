...
A system of linear equations, $\linearsystem{A}{\vect{b}}$ is \define{homogeneous} if the vector of constants is the zero vector, in other words, $\vect{b}=\zerovector$.
%
\end{definition}
%
