...
\end{example}
%
The ideas of this subsection will be appear again in \acronymref{chapter}{LT} when we discuss pre-images of linear transformations (\acronymref{definition}{PI}).
%
%  End  lc.tex
