...
\ifthenelse{\boolean{hassage}}{\computedevicetopic{SAGE}{SAGE}{sage}{VLC}{Vector Linear Combinations}{vector linear combinations}}{\relax}
}{
...
\ifthenelse{\boolean{hassage}}{\quad\acronymref{computation}{VLC.SAGE}}{\relax}
}
%
...
\begin{itemize}
%
\item\property{ACC}{Additive Closure, Column Vectors}{additive closure!column vectors}
