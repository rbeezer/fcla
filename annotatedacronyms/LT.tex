...
The pre-image will be an important construction in this chapter, and this is one of the most important descriptions of the pre-image.  It should remind you of \acronymref{theorem}{PSPHS}, which is described in \acronymref{acronyms}{V}.  See \acronymref{theorem}{RPI}, which is also described below.
}
%
